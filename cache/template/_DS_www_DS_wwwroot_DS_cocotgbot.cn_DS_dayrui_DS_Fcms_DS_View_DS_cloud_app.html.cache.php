        ...
        <table class="table table-striped table-bordered table-hover table-checkable dataTable">
            ...
            <tr class="odd gradeX">
                ...
                <td style="overflow: auto">
                    ...
                    <?php }  } ?>
                    <label><a href="javascript:dr_load_ajax('<?php echo dr_lang($dir == 'module' ? '卸载建站系统会清空所有栏目及其内容，确定要卸载吗？' : '确定卸载此程序吗？'); ?>', '<?php echo dr_url('cloud/uninstall', ['dir'=>$dir]); ?>', 1);" class="btn btn-xs red"> <i class="fa fa-trash"></i> <?php echo dr_lang('卸载'); ?> </a></label>
                    <?php } else { ?>
