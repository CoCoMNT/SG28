...
class Lotus
{
	...
	protected function prepareConfig()
	{
        if (!class_exists('LtObjectUtil')) {
            ...
            require_once $this->lotusRuntimeDir . "Config.php";
            require_once dirname($this->lotusRuntimeDir) . "/aop/request/AlipayTradePagePayRequest.php";
            require_once dirname($this->lotusRuntimeDir) . "/aop/AopClient.php";
        }
